...
const OurPolicy = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center pb-0 py-20 text-xs sm:text-sm md:text-base text-slate-700">
      <div>
        <RiExchangeFundsFill className="w-10 h-10 m-auto mb-5" />

        <p className="font-semibold">Exchange Policy</p>
        <p className="text-slate-400">We offer free exchange policy</p>
      </div>
      <div>
        <FaCheckCircle className="w-10 h-10 m-auto mb-5" />

        <p className="font-semibold">3 Days return Policy</p>
        <p className="text-slate-400">We provide 3 days return policy</p>
      </div>
      <div>
